        ...
        execute: function() {
            ListService = (function () {
                function ListService() {
                    ...
                    this.ticketsLocalStorage = JSON.parse(localStorage.getItem('sp-ticketlist'));
                    this.ticketsDefaultData = list_data_constant_1.TICKETS;
                    this.ticketsToReturn = this.ticketsDefaultData;
                }
                ...
                ListService.prototype.getTickets = function () {
                ...
                ListService.prototype.setTickets = function (bookmarks) {
